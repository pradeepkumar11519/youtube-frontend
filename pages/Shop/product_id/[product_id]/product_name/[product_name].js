...
export default function Product_Name(props) {
  ...
  const {user,setEach_Product} = useContext(Context)
            ...
            <img crossOrigin={true} alt="ecommerce" className="lg:w-1/2 w-full  object-cover object-center rounded" src={ImageColor}/>
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex justify-between">
                  ...
                  <div className='flex'>
                  <button className="flex  text-white bg-indigo-500 border-0 py-2 px-6 ml-4 focus:outline-none hover:bg-indigo-600 rounded" onClick={()=>{
                    onSubmit(ImageColor)
                  }}>ADD TO KART</button>
                  <button className="flex  text-white bg-indigo-500 border-0 py-2 px-6 ml-4 focus:outline-none hover:bg-indigo-600 rounded" onClick={()=>{
